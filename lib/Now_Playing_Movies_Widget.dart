...
class Now_Playing_Movies_Widget extends StatefulWidget {
  final Genre? selectedGenre;
  const Now_Playing_Movies_Widget({super.key, this.selectedGenre});

  @override
  State<Now_Playing_Movies_Widget> createState() =>
      _Now_Playing_Movies_WidgetState();
}

class _Now_Playing_Movies_WidgetState
    extends State<Now_Playing_Movies_Widget> {
  late Future<List<UpcomingMovies>> _future;

  @override
  void initState() {
    super.initState();
    final cacheKey = 'now_playing_${widget.selectedGenre?.id}';
  ...
  @override
  void didUpdateWidget(Now_Playing_Movies_Widget oldWidget) {
  ...
  Future<List<UpcomingMovies>> _fetchData() async {
    ...
    final cacheKey = 'now_playing_$genreId';
    final url = genreId == null
        ? 'https://api.themoviedb.org/3/movie/now_playing?api_key=e850641520c5c6eacf9b2f679e373ff4'
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return PremiumMovieCard(
              ...
              heroTag: 'nowplaying_${movie.id}_$index',
