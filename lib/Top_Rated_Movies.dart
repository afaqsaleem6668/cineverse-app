...
class TopRatedMovies extends StatefulWidget {
  ...
  const TopRatedMovies({Key? key, this.selectedGenre}) : super(key: key);
...
class _TopRatedMoviesState extends State<TopRatedMovies> {
  ...
  void initState() {
    super.initState();
    final cacheKey = 'top_rated_movies_${widget.selectedGenre?.id}';
  ...
  @override
  void didUpdateWidget(TopRatedMovies oldWidget) {
  ...
  Future<List<UpcomingMovies>> _fetchData() async {
    ...
    final cacheKey = 'top_rated_movies_$genreId';
    final url = genreId == null
        ? 'https://api.themoviedb.org/3/movie/top_rated?api_key=e850641520c5c6eacf9b2f679e373ff4'
        : 'https://api.themoviedb.org/3/discover/movie?api_key=e850641520c5c6eacf9b2f679e373ff4&with_genres=$genreId&sort_by=vote_average.desc';
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return PremiumMovieCard(
              ...
              heroTag: 'toprated_m_${movie.id}_$index',
