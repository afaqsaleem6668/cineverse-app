...
class OnTheAir extends StatefulWidget {
  const OnTheAir({super.key, this.selectedGenre});
...
class _OnTheAirState extends State<OnTheAir> {
  ...
  void initState() {
    super.initState();
    final cacheKey = 'on_the_air_${widget.selectedGenre?.id}';
  ...
  @override
  void didUpdateWidget(OnTheAir oldWidget) {
  ...
  Future<List<PopularTvShows>> _fetchData() async {
    ...
    final cacheKey = 'on_the_air_$genreId';
    final url = genreId == null
        ? 'https://api.themoviedb.org/3/tv/on_the_air?api_key=e850641520c5c6eacf9b2f679e373ff4'
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return PremiumMovieCard(
              ...
              heroTag: 'ontheair_${show.id}_$index',
